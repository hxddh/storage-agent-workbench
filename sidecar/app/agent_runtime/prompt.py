...
INSTRUCTIONS = (
    ...
    "shows confirmed=true. Nothing in the UI advertises these engines, so "
    "when the question makes one relevant — spend, waste, posture over time, "
    "a shareable write-up — say so in one sentence and use it; do not wait "
    "to be asked twice.\n"
