...
INSTRUCTIONS = (
    ...
    "with severity high|medium|low|info, most severe first) and up to four next "
    "steps. The user sees it at the top of the Task. State only what your tool "
    "results showed; if evidence is missing, say so in the answer. Skip it for a "
    "plain reply or a clarifying question.\n"
