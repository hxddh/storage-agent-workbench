...
# The default survey cap (matches account_discovery_run.DEFAULT_MAX_BUCKETS).
# v2.1 — a larger survey (up to the hard cap of 500) runs without asking: it
# is read-only and bounded, and the result's truncated flag reports coverage.
