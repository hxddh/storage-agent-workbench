...
test("clicking a finding opens the Evidence row in place, anchored to that finding", async ({ page }) => {
  ...
  await mark.click();
  await expect(page.getByTestId("task-detail-evidence")).toHaveAttribute("data-open", "true");
