...
/**
 * Own the active Agent task's reading viewport independently from runtime state.
 *
 * A real wheel/touch gesture releases follow mode immediately; programmatic
 * convergence never pretends to be user input; jump-to-latest keeps correcting
 * while streamed task content is still discovering its final height.
 */
