...
const en: Dict = {
  ...
  "rail.day.today": "Today",
  "rail.day.yesterday": "Yesterday",
  "rail.day.week": "Last 7 days",
  "rail.day.month": "Last 30 days",
  "rail.day.older": "Older",
  // keyboard shortcuts sheet (v0.46.0)
  "keys.title": "Keyboard shortcuts",
  "keys.groupGlobal": "Global",
  "keys.groupChat": "In a chat",
  ...
  "keys.find": "Find in this investigation",
  "keys.prevTurn": "Previous exchange",
  "keys.nextTurn": "Next exchange",
  "find.placeholder": "Find in this investigation…",
  "find.counter": "{i} / {n}",
  ...
  "thread.placeholder": "Ask Storage Agent…",
  "thread.startWith": "Start with",
  "thread.errTitle": "Couldn\u2019t send your message.",
  "thread.offline": "The local service is not responding, so nothing can run right now.",
  "thread.offlineHint": "Reconnecting automatically. Your text is kept — it will send once the service is back.",
  "thread.send": "send",
  ...
  "thread.progress": "{n} checks run",
  "thread.stop": "Stop",
  "thread.redirect": "Redirect",
  "thread.redirectHint": "Send to redirect — keeps what it already found",
  "thread.stoppedByUser": "Stopped by user",
  "thread.uploading": "Uploading {name}…",
  "attach.promptInventory": "Analyze this inventory file.",
  "attach.promptLog": "Analyze this log file.",
  "thread.loadFailed": "Couldn't load this session.",
  "thread.retry": "Retry",
  "thread.reload": "Reload",
  "thread.stalled": "This is taking longer than expected — the answer may already be ready.",
  "thread.redirectCurrent": "redirect current turn",
  ...
  "inspector.statFailed": "{n} failed",
  "inspector.statToolTime": "Time in tools",
  "inspector.statTokens": "Tokens",
  "inspector.statAudit": "Audit events",
  "inspector.statApprovals": "{n} approvals",
  "inspector.tokensIn": "{n} in",
  "inspector.tokensPartial": "partial — {n}/{total} turns reported",
  "inspector.tokensUnavailable": "not reported by the provider",
  "inspector.chipTools": "Tools",
  "inspector.chipAudit": "Audit",
  "inspector.chipErrors": "Errors only",
  "inspector.input": "Input",
  "inspector.output": "Output",
  "inspector.showing": "Showing {n} of {total} entries",
  "inspector.loadMore": "Load more",
  "inspector.loading": "Loading…",
  "inspector.empty": "Nothing recorded for this session yet.",
  "thread.inspect": "Session inspector",
  // thread interaction (v0.46.0)
  "thread.jumpLatest": "Jump to latest",
  "thread.jumpWriting": "Jump to latest · still writing",
  "thread.loadEarlier": "Load earlier ({n} more)",
  ...
  "msg.branch": "Branch a new investigation from here",
  ...
  "proposal.next": "next",
  "proposal.continueTitle": "Continue investigation",
  ...
  "act.continueInvestigation": "Continue the investigation from where you left off — pick up the threads you hadn't reached yet and go deeper.",
  // run transcript (RunDetail / ToolTimeline / ToolResultCard)
  "run.back": "Back",
  ...
  "timeline.hideOutput": "hide",
  "timeline.showOutput": "output",
...
const zh: Dict = {
  ...
  "rail.resize": "调整侧栏宽度",
  "rail.day.today": "今天",
  "rail.day.yesterday": "昨天",
  "rail.day.week": "过去 7 天",
  "rail.day.month": "过去 30 天",
  "rail.day.older": "更早",
  // 快捷键面板 (v0.46.0)
  "keys.title": "键盘快捷键",
  "keys.groupGlobal": "全局",
  ...
  "thread.placeholder": "向云存储 Agent 提问…",
  "thread.startWith": "从这里开始",
  "thread.errTitle": "消息没能发送。",
  "thread.offline": "本地服务没有响应，现在什么都跑不了。",
  "thread.offlineHint": "正在自动重连。你输入的内容会保留 —— 服务恢复后即可发送。",
  "thread.send": "发送",
  "thread.progress": "已完成 {n} 项检查",
  "thread.redirect": "改向",
  "thread.redirectHint": "发送以改变方向 —— 保留已查到的内容",
  ...
  "thread.newline": "换行",
  "thread.stop": "停止",
  "thread.stoppedByUser": "已由用户停止",
  "thread.uploading": "正在上传 {name}…",
  "attach.promptInventory": "请分析这个清单文件。",
  "attach.promptLog": "请分析这个日志文件。",
  "thread.loadFailed": "无法加载此会话。",
  "thread.retry": "重试",
  "thread.reload": "重新加载",
  "thread.stalled": "耗时比预期更久——答案可能已经就绪。",
  "thread.redirectCurrent": "改向当前回合",
  ...
  "inspector.statFailed": "{n} 次失败",
  "inspector.statToolTime": "工具耗时",
  "inspector.statTokens": "Token",
  "inspector.statAudit": "审计事件",
  "inspector.statApprovals": "{n} 次确认",
  "inspector.tokensIn": "输入 {n}",
  "inspector.tokensPartial": "不完整 — {total} 轮中有 {n} 轮上报",
  "inspector.tokensUnavailable": "服务未上报",
  "inspector.chipTools": "工具",
  "inspector.chipAudit": "审计",
  "inspector.chipErrors": "仅错误",
  "inspector.input": "输入",
  "inspector.output": "输出",
  "inspector.showing": "已显示 {total} 条中的 {n} 条",
  "inspector.loadMore": "载入更多",
  "inspector.loading": "载入中…",
  "inspector.empty": "本会话暂无记录。",
  "thread.inspect": "会话检查器",
  // 线程交互 (v0.46.0)
  "thread.jumpLatest": "回到最新",
  "thread.jumpWriting": "回到最新 · 仍在生成",
  "thread.loadEarlier": "载入更早（还有 {n} 条）",
  ...
  "timeline.hideOutput": "收起",
  "timeline.showOutput": "输出",
