...
export function useTaskCopy() {
  ...
  return lang === "zh"
    ? {
        ...
        resumeAction: "恢复执行",
        queued: "排队中",
        queuedSteerFollowup: "补充方向的后续执行",
        queuedHint: "排队中 · 当前执行结束后开始",
        queuedSteerHint: "补充方向 · 当前执行结束后开始",
        queuedCancel: "取消",
        queuedEdit: "编辑",
        queuedSave: "保存",
    ...
    : {
        ...
        queued: "Queued",
        queuedSteerFollowup: "Steer follow-up",
        queuedHint: "Queued · starts when the current execution finishes",
        queuedSteerHint: "Steer follow-up · starts when the current execution finishes",
        queuedCancel: "Cancel",
        queuedEdit: "Edit",
        queuedSave: "Save",
