...
export function useTaskCopy() {
  ...
  return lang === "zh"
    ? {
        ...
        resumeBody: "它没能自动继续——通常是因为当时没有可用的模型。“恢复执行”会按同一个方向开始新的执行。",
        resumeAction: "恢复执行",
        queued: "排队中",
    ...
    : {
        ...
        resumeBody: "It could not continue on its own — usually because no model was available. Resume starts a new Execution from the same Direction.",
