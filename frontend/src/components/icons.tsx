...
const PATHS: Record<string, string> = {
  ...
  play: "M8 5v14l11-7z",
  chip: "M8 4.5h8A3.5 3.5 0 0 1 19.5 8v8a3.5 3.5 0 0 1-3.5 3.5H8A3.5 3.5 0 0 1 4.5 16V8A3.5 3.5 0 0 1 8 4.5z|M9.5 9.5h5v5h-5z|M9.5 2v2.5|M14.5 2v2.5|M9.5 19.5V22|M14.5 19.5V22|M2 9.5h2.5|M2 14.5h2.5|M19.5 9.5H22|M19.5 14.5H22",
