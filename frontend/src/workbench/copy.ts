...
const COPY = {
  en: {
    task: {
      ...
      readyEyebrow: "Storage Agent",
      startTitle: "What should the Agent do?",
      startDescription: "Describe the outcome you want. The Agent can inspect, diagnose and analyze your object storage using the configured read-only capabilities.",
    },
    states: {
  ...
  zh: {
    task: {
      ...
      readyEyebrow: "Storage Agent",
      startTitle: "你希望 Agent 完成什么？",
      startDescription: "直接描述目标和期望结果。Agent 会使用已配置的只读能力检查、诊断和分析对象存储，并在执行过程中接受你的 Steering。",
    },
    states: {
      working: "Agent 工作中",
