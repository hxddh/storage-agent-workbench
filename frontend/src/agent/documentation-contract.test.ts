...
describe("v1.14 documentation contract", () => {
  it("anchors normative documentation to the current Agent Task architecture", () => {
    ...
    expect(readRepo("docs/README.md")).toContain("v1.14.0");
    expect(readRepo("CLAUDE.md")).toContain("v1.14.0");
  ...
  it("pins high-risk current docs to shipped runtime facts", () => {
    ...
    expect(readRepo("docs/product.md")).toContain("v1.14");
    expect(readRepo("docs/architecture.md")).toContain("v1.14.0");
    ...
    expect(readRepo("docs/roadmap.md")).toContain("v1.14.0");
  });
