...
const COPY = {
  en: {
    ...
    artifacts: {
      ...
      empty: {
        evidence: "No evidence recorded for this task yet.",
        reports: "No report has been written for this task yet.",
        plans: "No remediation plan has been drafted for this task.",
        baselines: "No baseline or drift report exists for this task.",
        execution: "No execution records on this task yet.",
      },
      report: "Task report",
      plan: {
  ...
  zh: {
    ...
    artifacts: {
      ...
      empty: {
        evidence: "这个任务还没有记录证据。",
        reports: "这个任务还没有生成报告。",
        plans: "这个任务还没有起草整改方案。",
        baselines: "这个任务还没有基线或漂移报告。",
        execution: "这个任务还没有执行记录。",
      },
      report: "任务报告",
      plan: {
        version: (version: number) => `v${version}`,
