...
> **Implementation contract for Storage Agent v2.2.0.**
>
...
The v2.2.0 product invariant is:
...
## 1. Never regress the v2.2.0 native, result-first Agent window
