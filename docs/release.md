...
> **Current process baseline: Storage Agent v1.05.0.**
>
...
The GitHub tag and public asset names keep the release-branch spelling (`v1.05.0`). Bundle metadata is canonical semver (`1.4.0`): leading zeros in numeric components are stripped because Tauri and Cargo reject `1.02.0`.
