...
> **Current architecture baseline: Storage Agent v1.06.0.** Thorough native Agent window. Sidecar engines from v0.96 remain; they have no product UI entry. Product invariant unchanged.
>
