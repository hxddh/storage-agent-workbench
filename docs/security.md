...
> **Storage Agent v1.08.0 security contract.** Unchanged from v0.96.0; v1.03 keeps the v1.02 window and adds gated extensions — local models, user skills, MCP, observability, OS shell — same safety floor.
>
