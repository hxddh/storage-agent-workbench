...
> **Storage Agent v1.04.0 API reference.** Provenance projection unchanged from v1.02.0; v1.03 adds Skills, Observability export and MCP bridge, v1.04 keeps the window and adds warm editorial + Codex/Cursor layout. Unchanged from
