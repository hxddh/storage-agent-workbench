...
This document preserves the phase-by-phase implementation notes that previously
lived in README.md. It is historical implementation context, not the primary
project overview. For the current product overview see [README.md](../README.md).
